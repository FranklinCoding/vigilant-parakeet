    ...
    <>
      ...
      <div className="watchlist-drawer" role="dialog" aria-label="Watchlist">
        <div className="watchlist-drawer__header">
          ...
          <button className="watchlist-drawer__close" onClick={onClose} aria-label="Close">x</button>
        </div>
        <div className="watchlist-drawer__body">
          {watchlist.length === 0 ? (
            <div className="watchlist-empty">
              <div className="watchlist-empty__icon">Save</div>
              <div className="watchlist-empty__title">Nothing here yet</div>
              <div className="watchlist-empty__sub">
                Save games from the discovery feed so you can revisit them later.
              </div>
            </div>
          ) : (
            watchlist.map((item) => (
